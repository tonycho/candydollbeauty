...
if (class_exists('WooCommerce')) {
    ...
    ?>
    <article id="product-<?php the_ID(); ?>" <?php post_class(array('element', 'product-style-2', 'product-animate', $catalog_mode_class)); ?>
...
foreach ( $brands_list as $brand ) {
    echo "<a class='brand' href='/brands/" . $brand->slug . "'>" . $brand->name . "</a>";
}
 ?>
